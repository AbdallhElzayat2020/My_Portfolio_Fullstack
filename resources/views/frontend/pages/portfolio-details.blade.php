                            ...
                            <div class="card-body portfolio-card">
                                <div class="portfolio-details-area">
                                    <div class="main-image">
                                        <img src="{{ asset('assets/frontend/img/projects/project-details-1.png') }}"
                                    ...
                                    <div class="portfolio-details-text">
                                        ...
                                        <div class="overview">
                                            ...
                                            <p>Web design encompasses the process of creating and designing websites
                                                It involves a
                                                combination of different skills and disciplines to produce a
                                                visually appealing and
                                                user-friendly website. Here's an overview of key aspects of web
                                                design.</p>
                                            <p>
                                                <b>Research:</b> Before starting the design, it's essential to
                                                understand the target audience,
                                                their
                                                needs, and the goals of the website.

                                            </p>
                                            <p><b>Information Architecture:</b> Organize and structure the content
                                                to ensure a logical flow
                                                for
                                                users.</p>
                                            <p> <b>Wireframing and Prototyping:</b> Create skeletal outlines and
                                                interactive prototypes to
                                                visualize
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="image-item">
                                                    <img src="{{ asset('assets/frontend/img/projects/project-details-2.png') }}"
                                                        alt="project-details-2" class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="image-item">
                                                    <img src="{{ asset('assets/frontend/img/projects/project-details-3.png') }}"
                                                        alt="project-details-3" class="img-fluid w-100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
