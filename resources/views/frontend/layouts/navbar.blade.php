<header class="header-area">
    <div class="container">
        <div class="menu-container">
            <div class="logo">
                <a class="navbar-brand me-0" href="{{ route('website.home') }}">
                    <img width="24" height="24" src="{{asset('assets/frontend/img/logo.ico')}}" alt="MailLogo">

                    <span>Abd<span class="primary">allh</span></span>
                </a>
            </div>
            <div class="navbar-main d-flex flex-grow-1">
                ...
                <div class="header-right-info d-flex align-items-center">
                    ...
                    <!-- Dark and Light Mood Button -->
                    <!-- Lets Talk button  -->
                    <a href="https://wa.me/201212484233?text=Hello%20I%20want%20to%20inquire%20about%20your%20services"
                        target="_blank" class="lets-talk-btn">
                        Let's Talk
