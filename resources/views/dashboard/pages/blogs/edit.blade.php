                    ...
                    <form action="{{ route('blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="full_name"
                                        value="{{ old('full_name', $blog->full_name) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="short_name"
                                        value="{{ old('short_name', $blog->short_name) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="short_desc" name="short_desc" rows="3"
                                class="form-control @error('short_desc') is-invalid @enderror">{{ old('short_desc', $blog->short_desc) }}</textarea>
                            @error('short_desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="full_desc" name="full_desc"
                                class="form-control @error('full_desc') is-invalid @enderror">{{ old('full_desc', $blog->full_desc) }}</textarea>
                            @error('full_desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
