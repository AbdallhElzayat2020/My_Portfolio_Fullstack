...
@section('title', 'Edit Numbers')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Numbers / Statistics</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('main-steps.update', $number) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="experience_year"
                                        value="{{ old('experience_year', $number->experience_year) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="complete_project"
                                        value="{{ old('complete_project', $number->complete_project) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="happy_client"
                                        value="{{ old('happy_client', $number->happy_client) }}"
